...
- `assets/Sounds/pulse.aiff`
- `assets/Sounds/relay.aiff`
...
- https://elevenlabs.io/sound-effects/glitch
- https://elevenlabs.io/docs/api-reference/text-to-sound-effects/convert
- https://elevenlabs.io/terms-of-use

Attribution: sound effects generated with ElevenLabs.

## Iconography

The application and menu-bar icons are original vector drawings rendered from `native/IconRenderer.swift` and `native/LayoutPilot.swift`.
